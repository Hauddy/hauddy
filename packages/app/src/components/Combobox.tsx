...
export interface ComboItem {
  /** The value handed back on select (e.g. a handle or localId). */
  value: string;
 ...
 *  you type; ↑/↓ move, Enter/click select, Esc closes. One control, reused by the
 *  add-to-book picker and the Messages recipient field. */
